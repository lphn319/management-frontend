...
export class ProductsComponent implements OnInit {
  ...
  applyFilter(): void {
    this.dataSource.filterPredicate = (data: Product, filter: string) => {
      ...
      const matchBrand = !this.filterBrand ||
        data.brand.id === this.filterBrand;
      ...
      if (this.filterStock) {
        switch (this.filterStock) {
          ...
          case 'out-of-stock':
            ...
            break;
          case 'low-stock':
            matchStock = data.quantity > 0 && data.quantity < 5;
            break;
          default:
            matchStock = true;
            break;
            ...
            .subscribe({
              next: (updatedProduct) => {
                ...
                if (index !== -1) {
                  ...
                  this.dataSource.data = [...this.products]; // Cập nhật lại dữ liệu cho bảng
                }
